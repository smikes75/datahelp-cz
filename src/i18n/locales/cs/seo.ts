export const seo = {
  home: {
    title: "DataHelp.cz - Profesionální záchrana dat | HDD, SSD, RAID/NAS obnova",
    description: "Profesionální služby záchrany dat s více než 20 lety zkušeností. Specializujeme se na obnovu HDD, SSD a RAID/NAS systémů. Garance: žádná data = žádná platba.",
    keywords: "záchrana dat, obnova dat, HDD recovery, SSD recovery, RAID recovery, NAS recovery, profesionální záchrana dat Praha, oprava pevného disku, obnova smazaných dat"
  },
  about: {
    title: "O nás | 20+ let zkušeností v záchraně dat | DataHelp.cz",
  ...
  services: {
    ...
    description: "Komplexní služby záchrany dat pro HDD, SSD, RAID/NAS systémy a firemní řešení. Specializovaná laboratoř s více než 20 lety zkušeností. Bezplatná diagnostika.",
    keywords: "služby záchrany dat, hdd obnova, ssd recovery, raid systémy, nas recovery, raid/nas obnova, firemní řešení, laboratoř záchrany dat"
  },
  contact: {
    title: "Kontakt | 24/7 pohotovost | Záchrana dat Praha | DataHelp.cz",
