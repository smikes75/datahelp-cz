...
import { Phone, Mail, MessageSquare, Building, MapPin, ChevronDown, ChevronUp, Truck } from 'lucide-react';
...
function PartnersSection({ partners }: { partners: Array<{ country: string; city: string; address: string; phone: string; email: string }> }) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-8">
      <button
        ...
        className="flex items-center justify-between w-full text-left group mb-6"
      >
            ...
            <div key={index} className="border-l-4 border-accent pl-4">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm accent-text mb-2">{partner.country}</p>
...
function ContactInfoSection() {
  const { t } = useTranslation();  const [showBilling, setShowBilling] = useState(false);
