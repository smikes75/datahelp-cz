...
function ServicesPage() {
  const { t } = useTranslation();  const seo = useSEO('services');
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {timelineSteps.map((step, idx) => {
                const stepData = t(`services.timeline.steps.${step.key}`, { returnObjects: true }) as { title: string; description: string };
                ...
                return (
                  ...
                  >
                    ...
                    <div className={`transition-all duration-300 ${
                      ...
                      {stepData.details && (
                        <p className="text-sm text-gray-500 mt-1">{stepData.details}</p>
                      )}
                    </div>
                  </div>
                );
