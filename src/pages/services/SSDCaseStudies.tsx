...
import { Smartphone, CheckCircle, Clock, Banknote } from 'lucide-react';
...
function SSDCaseStudies() {
  const { t } = useTranslation();  const ssdCases = getCaseStudies('ssd', 'cs');
                ...
                <div className="md:w-2/3 p-6">
                  ...
                  <div className="grid md:grid-cols-3 gap-4 mb-6">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <span>Cena: {index === 0 ? '7 000 Kč' : index === 1 ? '8 750 Kč' : '10 500 Kč'}</span>
                    </div>
                  </div>
