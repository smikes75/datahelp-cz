...
import { Database, CheckCircle, Clock, Banknote } from 'lucide-react';
...
function RAIDCaseStudies() {
  const { t } = useTranslation();  const raidCases = getCaseStudies('raid', 'cs');
                ...
                <div className="md:w-2/3 p-6">
                  ...
                  <div className="grid md:grid-cols-3 gap-4 mb-6">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <span>Cena: {index === 0 ? '22 250 Kč' : index === 1 ? '30 000 Kč' : '36 250 Kč'}</span>
                    </div>
                  </div>
